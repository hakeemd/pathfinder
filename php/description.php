...
//if (isset($_POST['a2']) === true && empty($_POST['a2']) === false) {
  ...
  $result = mysqli_query($con,"SELECT description FROM result
  ...
  /*
  echo (mysqli_num_rows($result)!==0)?$row[answer1]:"Name not found";
  echo (mysqli_num_rows($result)!==0)?$row[answer2]:"Name not found";
  echo (mysqli_num_rows($result)!==0)?$row[answer3]:"Name not found";
  echo (mysqli_num_rows($result)!==0)?$row[answer4]:"Name not found";
  echo (mysqli_num_rows($result)!==0)?$row[answer5]:"Name not found";
  */
